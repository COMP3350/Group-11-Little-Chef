...
public class ReadRateRecipeAcceptanceTest3 {
    ...
    @Test
    public void readRateRecipeAcceptanceTest3() {
        ...
        ViewInteraction materialRadioButton = onView(
                allOf(withId(R.id.difficulty_radio_5), withText("5"),
                        childAtPosition(
        ...
        ViewInteraction materialRadioButton2 = onView(
                allOf(withId(R.id.taste_radio_5), withText("5"),
                        childAtPosition(
