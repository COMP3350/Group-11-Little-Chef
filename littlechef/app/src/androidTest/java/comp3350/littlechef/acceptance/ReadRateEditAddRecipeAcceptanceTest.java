...
public class ReadRateEditAddRecipeAcceptanceTest
{
    ...
    public void testTypicalCases()
    {
        ...
        onView(withId(R.id.cancel_adding_instructions_button)).check(matches(isDisplayed()));
        ...
        onView(withId(R.id.new_recipe_name_input)).check(matches(isDisplayed())).perform(typeText("Hard-cooked eggs"));
        ...
        onView(withId(R.id.new_ingredient_name)).check(matches(isDisplayed())).perform(typeText("Kosher salt"));
        onView(withId(R.id.new_ingredient_amount)).check(matches(isDisplayed())).perform(typeText("0.25"));
        ...
        onView(withId(R.id.new_ingredient_name)).check(matches(isDisplayed())).perform(typeText("Fresh Lime or Lemon Juice"));
        onView(withId(R.id.new_ingredient_amount)).check(matches(isDisplayed())).perform(typeText("1.0"));
        onView(withId(R.id.spinnerUnit)).check(matches(isDisplayed())).perform(click());
        onData(allOf(is(instanceOf(String.class)),is("TBSP"))).inRoot(RootMatchers.isPlatformPopup()).perform(click());
        onView(withId(R.id.add_new_ingredient_button)).check(matches(isDisplayed())).perform(click());

        onView(withId(R.id.new_ingredient_name)).check(matches(isDisplayed())).perform(typeText("Minced Red Onion"));
        onView(withId(R.id.new_ingredient_amount)).check(matches(isDisplayed())).perform(typeText("4.0"));
        onView(withId(R.id.spinnerUnit)).check(matches(isDisplayed())).perform(click());
        onData(allOf(is(instanceOf(String.class)),is("TBSP"))).inRoot(RootMatchers.isPlatformPopup()).perform(click());
        onView(withId(R.id.add_new_ingredient_button)).check(matches(isDisplayed())).perform(click());

        onView(withId(R.id.new_ingredient_name)).check(matches(isDisplayed())).perform(typeText("Jalapeno chillis"));
        onView(withId(R.id.new_ingredient_amount)).check(matches(isDisplayed())).perform(typeText("2.0"));
        onView(withId(R.id.spinnerUnit)).check(matches(isDisplayed())).perform(click());
        onData(allOf(is(instanceOf(String.class)),is("QUANTITY"))).inRoot(RootMatchers.isPlatformPopup()).perform(click());
        onView(withId(R.id.add_new_ingredient_button)).check(matches(isDisplayed())).perform(click());

        onView(withId(R.id.new_ingredient_name)).check(matches(isDisplayed())).perform(typeText("Cilantro"));
        onView(withId(R.id.new_ingredient_amount)).check(matches(isDisplayed())).perform(typeText("2.0"));
        onView(withId(R.id.spinnerUnit)).check(matches(isDisplayed())).perform(click());
        onData(allOf(is(instanceOf(String.class)),is("TBSP"))).inRoot(RootMatchers.isPlatformPopup()).perform(click());
        onView(withId(R.id.add_new_ingredient_button)).check(matches(isDisplayed())).perform(click());

        onView(withId(R.id.new_ingredient_name)).check(matches(isDisplayed())).perform(typeText("Black Pepper"));
        onView(withId(R.id.new_ingredient_amount)).check(matches(isDisplayed())).perform(typeText("1.0"));
        onView(withId(R.id.spinnerUnit)).check(matches(isDisplayed())).perform(click());
        onData(allOf(is(instanceOf(String.class)),is("PINCH"))).inRoot(RootMatchers.isPlatformPopup()).perform(click());
        onView(withId(R.id.add_new_ingredient_button)).check(matches(isDisplayed())).perform(click());

        onView(withId(R.id.new_ingredient_name)).check(matches(isDisplayed())).perform(typeText("Ripe Tomato"));
        onView(withId(R.id.new_ingredient_amount)).check(matches(isDisplayed())).perform(typeText("0.5"));
        onView(withId(R.id.spinnerUnit)).check(matches(isDisplayed())).perform(click());
        onData(allOf(is(instanceOf(String.class)),is("QUANTITY"))).inRoot(RootMatchers.isPlatformPopup()).perform(click());
        onView(withId(R.id.add_new_ingredient_button)).check(matches(isDisplayed())).perform(click());
        ...
        Espresso.closeSoftKeyboard();
        onView(withId(R.id.instruction_steps)).check(matches(isDisplayed())).perform(typeText("Eggs first, then water. Why? Because if you put the eggs in afterward, they might crack as they fall to the bottom of the pan. It''s no fun to learn this the hard way."));
        Espresso.closeSoftKeyboard();
        ...
        //save the recipe
        onView(withId(R.id.all_instructions_added_button)).check(matches(isDisplayed())).perform(click());

        //add the default recipes Chicken Wrap
        onView(withId(R.id.add)).perform(click());
        onView(withId(R.id.new_recipe_name_input)).check(matches(isDisplayed())).perform(typeText("Chicken Wrap"));
        onView(withId(R.id.add_new_recipe_button)).check(matches(isDisplayed())).perform(click());

        //add ingredients
        onView(withId(R.id.new_ingredient_name)).check(matches(isDisplayed())).perform(typeText("Grilled Chicken Breasts copped"));
        onView(withId(R.id.new_ingredient_amount)).check(matches(isDisplayed())).perform(typeText("2.0"));
        onView(withId(R.id.spinnerUnit)).check(matches(isDisplayed())).perform(click());
        onData(allOf(is(instanceOf(String.class)),is("CUP"))).inRoot(RootMatchers.isPlatformPopup()).perform(click());
        onView(withId(R.id.add_new_ingredient_button)).check(matches(isDisplayed())).perform(click());

        onView(withId(R.id.new_ingredient_name)).check(matches(isDisplayed())).perform(typeText("Ranch Dressing"));
        onView(withId(R.id.new_ingredient_amount)).check(matches(isDisplayed())).perform(typeText("0.25"));
        onView(withId(R.id.spinnerUnit)).check(matches(isDisplayed())).perform(click());
        onData(allOf(is(instanceOf(String.class)),is("CUP"))).inRoot(RootMatchers.isPlatformPopup()).perform(click());
        onView(withId(R.id.add_new_ingredient_button)).check(matches(isDisplayed())).perform(click());

        onView(withId(R.id.new_ingredient_name)).check(matches(isDisplayed())).perform(typeText("Mozzarella Cheese"));
        onView(withId(R.id.new_ingredient_amount)).check(matches(isDisplayed())).perform(typeText("0.5"));
        onView(withId(R.id.spinnerUnit)).check(matches(isDisplayed())).perform(click());
        onData(allOf(is(instanceOf(String.class)),is("CUP"))).inRoot(RootMatchers.isPlatformPopup()).perform(click());
        onView(withId(R.id.add_new_ingredient_button)).check(matches(isDisplayed())).perform(click());
        ...
        onView(withId(R.id.new_ingredient_name)).check(matches(isDisplayed())).perform(typeText("8 inch tortillas"));
        onView(withId(R.id.new_ingredient_amount)).check(matches(isDisplayed())).perform(typeText("4.0"));
        onView(withId(R.id.spinnerUnit)).check(matches(isDisplayed())).perform(click());
        onData(allOf(is(instanceOf(String.class)),is("ML"))).inRoot(RootMatchers.isPlatformPopup()).perform(click());
        onView(withId(R.id.add_new_ingredient_button)).check(matches(isDisplayed())).perform(click());
        ...
        onView(withId(R.id.add)).perform(click());
        onView(withId(R.id.new_recipe_name_input)).check(matches(isDisplayed())).perform(typeText("Grilled Halloumi Salad"));
        onView(withId(R.id.add_new_recipe_button)).check(matches(isDisplayed())).perform(click());

        //add ingredients
        onView(withId(R.id.new_ingredient_name)).check(matches(isDisplayed())).perform(typeText("Halloumi Cheese, sliced into 1/4 inch thick slices"));
        onView(withId(R.id.new_ingredient_amount)).check(matches(isDisplayed())).perform(typeText("250"));
        onView(withId(R.id.spinnerUnit)).check(matches(isDisplayed())).perform(click());
        onData(allOf(is(instanceOf(String.class)),is("G"))).inRoot(RootMatchers.isPlatformPopup()).perform(click());
        onView(withId(R.id.add_new_ingredient_button)).check(matches(isDisplayed())).perform(click());

        onView(withId(R.id.new_ingredient_name)).check(matches(isDisplayed())).perform(typeText("Packed Spring Greens"));
        onView(withId(R.id.new_ingredient_amount)).check(matches(isDisplayed())).perform(typeText("2.0"));
        onView(withId(R.id.spinnerUnit)).check(matches(isDisplayed())).perform(click());
        onData(allOf(is(instanceOf(String.class)),is("CUP"))).inRoot(RootMatchers.isPlatformPopup()).perform(click());
        onView(withId(R.id.add_new_ingredient_button)).check(matches(isDisplayed())).perform(click());

        onView(withId(R.id.new_ingredient_name)).check(matches(isDisplayed())).perform(typeText("Chopped Cucumber"));
        onView(withId(R.id.new_ingredient_amount)).check(matches(isDisplayed())).perform(typeText("1.0"));
        onView(withId(R.id.spinnerUnit)).check(matches(isDisplayed())).perform(click());
        onData(allOf(is(instanceOf(String.class)),is("CUP"))).inRoot(RootMatchers.isPlatformPopup()).perform(click());
        onView(withId(R.id.add_new_ingredient_button)).check(matches(isDisplayed())).perform(click());

        onView(withId(R.id.new_ingredient_name)).check(matches(isDisplayed())).perform(typeText("Chopped Pineapple"));
        onView(withId(R.id.new_ingredient_amount)).check(matches(isDisplayed())).perform(typeText("1.50"));
        onView(withId(R.id.spinnerUnit)).check(matches(isDisplayed())).perform(click());
        onData(allOf(is(instanceOf(String.class)),is("CUP"))).inRoot(RootMatchers.isPlatformPopup()).perform(click());
        onView(withId(R.id.add_new_ingredient_button)).check(matches(isDisplayed())).perform(click());

        onView(withId(R.id.new_ingredient_name)).check(matches(isDisplayed())).perform(typeText("Red Onion, thinly sliced"));
        onView(withId(R.id.new_ingredient_amount)).check(matches(isDisplayed())).perform(typeText("0.2"));
        onView(withId(R.id.spinnerUnit)).check(matches(isDisplayed())).perform(click());
        onData(allOf(is(instanceOf(String.class)),is("QUANTITY"))).inRoot(RootMatchers.isPlatformPopup()).perform(click());
        onView(withId(R.id.add_new_ingredient_button)).check(matches(isDisplayed())).perform(click());

        onView(withId(R.id.new_ingredient_name)).check(matches(isDisplayed())).perform(typeText("Toasted Almonds"));
        onView(withId(R.id.new_ingredient_amount)).check(matches(isDisplayed())).perform(typeText("0.25"));
        onView(withId(R.id.spinnerUnit)).check(matches(isDisplayed())).perform(click());
        onData(allOf(is(instanceOf(String.class)),is("CUP"))).inRoot(RootMatchers.isPlatformPopup()).perform(click());
        onView(withId(R.id.add_new_ingredient_button)).check(matches(isDisplayed())).perform(click());

        onView(withId(R.id.new_ingredient_name)).check(matches(isDisplayed())).perform(typeText("Olive Oil"));
        onView(withId(R.id.new_ingredient_amount)).check(matches(isDisplayed())).perform(typeText("3.0"));
        onView(withId(R.id.spinnerUnit)).check(matches(isDisplayed())).perform(click());
        onData(allOf(is(instanceOf(String.class)),is("TBSP"))).inRoot(RootMatchers.isPlatformPopup()).perform(click());
        onView(withId(R.id.add_new_ingredient_button)).check(matches(isDisplayed())).perform(click());

        onView(withId(R.id.new_ingredient_name)).check(matches(isDisplayed())).perform(typeText("Lemon Juice"));
        onView(withId(R.id.new_ingredient_amount)).check(matches(isDisplayed())).perform(typeText("0.25"));
        onView(withId(R.id.spinnerUnit)).check(matches(isDisplayed())).perform(click());
        onData(allOf(is(instanceOf(String.class)),is("CUP"))).inRoot(RootMatchers.isPlatformPopup()).perform(click());
        onView(withId(R.id.add_new_ingredient_button)).check(matches(isDisplayed())).perform(click());

        onView(withId(R.id.new_ingredient_name)).check(matches(isDisplayed())).perform(typeText("Cayenne Pepper"));
        onView(withId(R.id.new_ingredient_amount)).check(matches(isDisplayed())).perform(typeText("0.25"));
        onView(withId(R.id.spinnerUnit)).check(matches(isDisplayed())).perform(click());
        onData(allOf(is(instanceOf(String.class)),is("TSP"))).inRoot(RootMatchers.isPlatformPopup()).perform(click());
        onView(withId(R.id.add_new_ingredient_button)).check(matches(isDisplayed())).perform(click());

        onView(withId(R.id.new_ingredient_name)).check(matches(isDisplayed())).perform(typeText("Salt"));
        onView(withId(R.id.new_ingredient_amount)).check(matches(isDisplayed())).perform(typeText("0.5"));
        onView(withId(R.id.spinnerUnit)).check(matches(isDisplayed())).perform(click());
        onData(allOf(is(instanceOf(String.class)),is("TSP"))).inRoot(RootMatchers.isPlatformPopup()).perform(click());
        onView(withId(R.id.add_new_ingredient_button)).check(matches(isDisplayed())).perform(click());
        ...
        Espresso.closeSoftKeyboard();
        onView(withId(R.id.instruction_steps)).check(matches(isDisplayed())).perform(typeText("Meanwhile, whisk all ingredients together in a small bowl (or shake in a covered mason jar) until completely combined. Set aside until ready to use."));
        Espresso.closeSoftKeyboard();
        onView(withId(R.id.add_new_instruction_button)).check(matches(isDisplayed())).perform(click());
        ...
        Espresso.closeSoftKeyboard();
        onView(withId(R.id.instruction_steps)).check(matches(isDisplayed())).perform(typeText("Add the remaining ingredients (arugula, cucumber, red onion, mint, Kalamata olives and pine nuts) to the large mixing bowl. Drizzle evenly with the dressing, and then toss until the salad is completely combined."));
        Espresso.closeSoftKeyboard();
        onView(withId(R.id.add_new_instruction_button)).check(matches(isDisplayed())).perform(click());

        onView(withId(R.id.instruction)).check(matches(isDisplayed())).perform(typeText("Season."));
        Espresso.closeSoftKeyboard();
        onView(withId(R.id.instruction_steps)).check(matches(isDisplayed())).perform(typeText("Taste and season the salad with extra salt, black pepper and/or lemon juice, if needed."));
        Espresso.closeSoftKeyboard();
        onView(withId(R.id.add_new_instruction_button)).check(matches(isDisplayed())).perform(click());

        onView(withId(R.id.instruction)).check(matches(isDisplayed())).perform(typeText("Serve."));
        Espresso.closeSoftKeyboard();
        onView(withId(R.id.instruction_steps)).check(matches(isDisplayed())).perform(typeText("Serve immediately and enjoy!"));
        Espresso.closeSoftKeyboard();
        onView(withId(R.id.add_new_instruction_button)).check(matches(isDisplayed())).perform(click());
